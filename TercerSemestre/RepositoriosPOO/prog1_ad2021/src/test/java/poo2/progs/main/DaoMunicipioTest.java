...
public class DaoMunicipioTest extends TestCase {
    ...
    private final static double PORCENTAJE_DAOMUN=3.0;
    ...
    public static void termina() throws Exception {
        ...
        System.out.printf("Puntos para Pruebas DAOMunicipio: %.2f/%.2f\n",calificacion*PORCENTAJE_DAOMUN/MAX_CALIF, PORCENTAJE_DAOMUN);
        TotalAcumulado.acumula(calificacion*PORCENTAJE_DAOMUN/MAX_CALIF);
