...
// y en un puerto en particular (8080)
    //  http://www.uaz.edu.mx:8080/RESTConcursos-34152734  <== URL_BASE

    // http://www.uaz.edu.mx:8080/RESTConcursos-34152734/servicios
...
public class AplicacionConfig extends Application {
    ...
    private void agregaRecursosREST(Set<Class<?>> recursos) {
        ...
        recursos.add(PersonaREST.class);
        recursos.add(DatosEstudianteREST.class);
        recursos.add(SedeREST.class);
        recursos.add(ConcursoREST.class);
        recursos.add(EquipoREST.class);
        recursos.add(EntidadREST.class);
        recursos.add(SedeConcursoREST.class);
        recursos.add(EquiposSedeConcursoREST.class);
    }
